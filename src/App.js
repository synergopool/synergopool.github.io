  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p className='ann'>
        Currently, there is 1 such staking pool for Verus, called Dudezmobi staking. It is run by a Verus community member and requires users that want to pool their stake to send over their funds to this community member. In other words, a custodial staking pool.        </p>
        <p className='ann'>
...
Using these Recover and Revoke capabilities of VerusIDs, this also means that Synergo Pool can never run off with your funds without you knowing about it beforehand.

Read more about VerusID here and join the Verus Discord to learn more.
        </p>
        <p className='ann'>
